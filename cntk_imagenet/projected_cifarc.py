...
def main():
    ...
    # Subset to # examples used for model in paper
    ...
    trainset, testset = d.get_cifar_c_data(shift_name='fog',
                                           path=cifarc_path,
                                           flatten=False)
    Xt_train, yt_train = trainset
    Xt_test, yt_test = testset
