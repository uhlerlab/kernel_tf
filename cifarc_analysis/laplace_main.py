...
def main():
    ...
    with open('csv_log/laplace_results.txt', 'w') as f:
        ...
        for shift in sorted(shifts):
            ...
            K = kernel.laplacian(torch.from_numpy(Xn_test),
                                 torch.from_numpy(X_train), bandwidth=10).numpy()
            ...
            sol_p, projected_acc = solve_exact(f1_preds, f1_test_preds,
